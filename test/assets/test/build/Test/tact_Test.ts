...
async function Test_init() {
    const __code = Cell.fromBase64('');
...
export const Test_errors_backward = {
    "Stack underflow": 2,
    "Stack overflow": 3,
    "Integer overflow": 4,
...
export class Test implements Contract {
    ...
    public static readonly errors = Test_errors_backward;
    public static readonly opcodes = Test_opcodes;
